...
**저장소**: [qws941/terraform](https://github.com/qws941/terraform)
**최종 수정**: 2026-02-12
**버전**: v1.0
...
| FR-01-06 | 시크릿 수집 스크립트 (`collect.go`) — 12개 프로젝트 스캔 | P0 | 완료 | - |
| FR-01-07 | 드리프트 감사 스크립트 (`audit.go`) | P0 | 완료 | - |
| FR-01-08 | 시크릿 동기화 스크립트 (`sync.go`) | P0 | 완료 | - |
...
|| NFR-01-04 | `audit.go` 출력에 `DO NOT COMMIT` 헤더 포함 | P0 | 완료 | - |
