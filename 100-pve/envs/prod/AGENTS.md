...
| Downstream consumption in 100-pve | `../../terraform/main.tf`, `../../terraform/locals.tf` | `module.hosts.hosts` feeds provisioning and config render locals. |
...
```bash
make plan SVC=pve
terraform -chdir=100-pve/terraform plan
```
