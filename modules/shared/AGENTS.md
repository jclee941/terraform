...
| Task | Module | Notes |
|------|--------|-------|
| **Retrieve Secrets** | `onepassword-secrets` | Uses `1Password/onepassword` provider with `section_map` access pattern. Outputs `secrets` (sensitive, 23 keys) + `metadata` (non-sensitive, 11 keys). |
...
| **Primary consumers** | `../../100-pve/AGENTS.md`, `../../105-elk/AGENTS.md`, `../../215-synology/AGENTS.md`, `../../300-cloudflare/AGENTS.md` | Workspace-level usage patterns for secret retrieval. |
