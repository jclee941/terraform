...
## CONSUMERS
- Called by `100-pve/terraform/secrets.tf` via `module.config_renderer`.
- Rendered outputs are consumed in `100-pve/terraform/lxc_configs.tf` and `100-pve/terraform/vm_configs.tf`.
...
| Upstream orchestrator | `100-pve/terraform/secrets.tf` | Supplies template vars and source files for all services. |
...
## ANTI-PATTERNS
- Do not hand-edit generated outputs under `100-pve/terraform/configs/rendered/`.
