...
```
Hosts(100,102,104,105,106,112,200-unmanaged) -> Filebeat -> Logstash:5044 -> Elasticsearch
                                                                      |
...
| oc        | 200  | 192.168.50.200 | system, opencode logs                   | unmanaged (manual filebeat config) |
...
- Alert Groups:
  ...
  2. `mcp-alerts`: error-logs.
  3. `infrastructure-health`: service-down, disk-usage-high, disk-usage-critical, ssl-cert-expiry.
- Data Sources:
