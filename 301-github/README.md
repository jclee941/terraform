...
| <a name="input_actions_allowed_patterns"></a> [actions\_allowed\_patterns](#input\_actions\_allowed\_patterns) | Allowed actions patterns when actions\_allowed\_actions is selected. | `list(string)` | <pre>[<br/>  "actions/checkout@*",<br/>  "actions/cache@*",<br/>  "actions/setup-*",<br/>  "anomalyco/opencode/*",<br/>  "cloudflare/wrangler-action@*"<br/>]</pre> | no |
