...
| [github_actions_organization_permissions.organization](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/actions_organization_permissions) | resource |
...
| [github_actions_repository_permissions.repositories](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/actions_repository_permissions) | resource |
| [github_actions_runner_group.groups](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/actions_runner_group) | resource |
...
| [github_issue_label.standard](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/issue_label) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_actions_allowed_actions"></a> [actions\_allowed\_actions](#input\_actions\_allowed\_actions) | Organization-level allowed actions policy: all, local\_only, selected. | `string` | `"selected"` | no |
| <a name="input_actions_allowed_patterns"></a> [actions\_allowed\_patterns](#input\_actions\_allowed\_patterns) | Allowed actions patterns when actions\_allowed\_actions is selected. | `list(string)` | <pre>[<br/>  "actions/checkout@*",<br/>  "actions/cache@*",<br/>  "actions/setup-*",<br/>  "anomalyco/opencode/*",<br/>  "cloudflare/wrangler-action@*",<br/>  "release-drafter/release-drafter@*",<br/>  "amannn/action-semantic-pull-request@*",<br/>  "dessant/lock-threads@*",<br/>  "CodelyTV/pr-size-labeler@*",<br/>  "terraform-docs/gh-actions@*"<br/>]</pre> | no |
| <a name="input_actions_enabled_repositories"></a> [actions\_enabled\_repositories](#input\_actions\_enabled\_repositories) | Organization-level enabled repositories policy: all, none, selected. | `string` | `"selected"` | no |
| <a name="input_actions_enabled_repositories_selected"></a> [actions\_enabled\_repositories\_selected](#input\_actions\_enabled\_repositories\_selected) | Selected repositories for org Actions enablement when policy is selected. | `set(string)` | <pre>[<br/>  "terraform"<br/>]</pre> | no |
...
| <a name="input_n8n_webhook_grafana_alert_url"></a> [n8n\_webhook\_grafana\_alert\_url](#input\_n8n\_webhook\_grafana\_alert\_url) | n8n webhook URL for Grafana alerts. | `string` | `""` | no |
...
| <a name="input_runner_groups"></a> [runner\_groups](#input\_runner\_groups) | Organization runner groups keyed by name. | <pre>map(object({<br/>    visibility                 = optional(string, "selected")<br/>    allows_public_repositories = optional(bool, false)<br/>    restricted_to_workflows    = optional(bool, false)<br/>    selected_workflows         = optional(list(string), [])<br/>    selected_repositories      = optional(set(string), [])<br/>  }))</pre> | <pre>{<br/>  "homelab": {<br/>    "allows_public_repositories": true,<br/>    "visibility": "all"<br/>  }<br/>}</pre> | no |
| <a name="input_security_code_scanning_tools"></a> [security\_code\_scanning\_tools](#input\_security\_code\_scanning\_tools) | Code scanning tools required by ruleset for each repository. | `map(set(string))` | <pre>{<br/>  "blacklist": [<br/>    "CodeQL"<br/>  ],<br/>  "hycu_fsds": [<br/>    "CodeQL"<br/>  ],<br/>  "propose": [<br/>    "CodeQL"<br/>  ],<br/>  "resume": [<br/>    "CodeQL"<br/>  ],<br/>  "safework2": [<br/>    "CodeQL"<br/>  ],<br/>  "splunk": [<br/>    "CodeQL"<br/>  ],<br/>  "terraform": [<br/>    "CodeQL"<br/>  ],<br/>  "tmux": [<br/>    "CodeQL"<br/>  ],<br/>  "youtube": [<br/>    "CodeQL"<br/>  ]<br/>}</pre> | no |
| <a name="input_security_dependabot_enabled"></a> [security\_dependabot\_enabled](#input\_security\_dependabot\_enabled) | Enable Dependabot security updates by repository. | `map(bool)` | <pre>{<br/>  "blacklist": true,<br/>  "hycu_fsds": true,<br/>  "propose": true,<br/>  "resume": true,<br/>  "safework2": true,<br/>  "splunk": true,<br/>  "terraform": true,<br/>  "tmux": true,<br/>  "youtube": true<br/>}</pre> | no |
